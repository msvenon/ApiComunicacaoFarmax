object DmExporterClient: TDmExporterClient
  ...
  object SqlBalancosFilial: TSQLDataSet
    CommandText = 
      ...
      'CLASSE,'#13#10'  CLASSE,'#13#10'  CUSTO_UNITARIO AS CUSTO_UNITARIO,'#13#10'  PRECO' +
      '_VENDA AS PRECO_VENDA,'#13#10'  PRECO_VENDA_ANTERIOR AS PRECO_VENDA_AN' +
      'TERIOR,'#13#10'  ESTOQUE,'#13#10'  ESTOQUE_ANTERIOR,'#13#10'  SUBSTITUIESTOQUE,'#13#10' ' +
      ' STATUS,'#13#10'  ENVIADO,'#13#10'  ID_MOTIVO,'#13#10'  DATA_CONTAGEM,'#13#10'  HORA_CON' +
      'TAGEM,'#13#10'  CODIGO_BARRAS_2'#13#10'FROM'#13#10' BALANCO'#13#10'WHERE'#13#10' ENVIADO = '#39'9'#39 +
      #13#10
    MaxBlobSize = -1
    Params = <>
    SQLConnection = SQLConnection1
  ...
  object SqlAtualizaItensCompra: TSQLDataSet
    CommandText = 
      ...
      'TUICAO,'#13#10'        :CUSTO_APLICADO'#13#10')'#13#10
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftFloat
